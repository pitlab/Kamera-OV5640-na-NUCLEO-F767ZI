...
const struct sensor_reg ov5640_init[] =
{
	...
	{0x302e, 0x00},
	{0x4300, 0x61}, // Format control: [7:4]3=YUV 422, YUYV, 6=RGB565, [3:0]
	{0x501f, 0x01}, // Format Mux control: [2:0] 0=ISP YUV422, 1= ISP RGB, 2=ISP dither, 3=ISP RAW, 4=SNR RAW, 5=ISP RAW (CIP)
	{0x440e, 0x00},
	...
	{0x4740, 0x23}, //Polarity CTRL00 {0x20}: [5] PCLK Polarity, [3] Gate PCLK under VSYNC, [2] Gate PCLK under HREF, [1] HREF polarity, [0]  VSYNC polarity
};



const struct sensor_reg ov5640_rgb565[] =
{
	...
	//kamera zbiera obraz z 640x480
	{0x3800, 0x03}, // HS X adr start H		(2592-640)/2 = 976 = 0x3D0
	{0x3801, 0xD0}, // HS X adr start L
	{0x3802, 0x02}, // VS Y adr start H		(1944-480)/2 = 732 = 0x2DC
	{0x3803, 0xDC}, // VS Y adr start L
	...
	//{0x3804, 0x06}, // HW X adr end H		976+640 = 1616 = 0x650
	//{0x3805, 0x50}, // HW X adr end L
	//{0x3806, 0x04}, // VH Y adr end H		732+480 = 1212 = 0x4BC
	//{0x3807, 0xBC}, // VH Y adr end L

	//wysyła 320x240
	{0x3808, 0x01}, // DVPHO DVP Output HorizH	1280=0x500, 320=0x140, 640=0x280
	{0x3809, 0x40}, // DVPHO DVP Output HorizL
	{0x380a, 0x00}, // DVPVO DVP output VertH		720=0x2D0, 240=0x0F0, 480=0x1E0
	{0x380b, 0xF0}, // DVPVO DVP output VertL

	{0x380c, 0x05}, // HTS Total Horizontal sizeH	1528=0x5F8
	{0x380d, 0xF8}, // HTS Total Horizontal sizeL
	{0x380e, 0x03}, // VTS Total Vertical sizeH 	1604=0x384
	{0x380f, 0x84}, // VTS Total Vertical sizeL
